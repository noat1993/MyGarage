...
public class NewEmployeeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSignup = (Button) findViewById(R.id.createButtEmp);
    ...
    public void onClick(View view) {
        ...
        if(view == buttonSignup){
            if(!editTextPassword.getText().toString().equals(editTextPasswordRepet.getText().toString())){
                ...
                Toast.makeText(NewEmployeeActivity.this, "your password isn't match", Toast.LENGTH_LONG).show();
            }
            else{

                Employes user = new Employes(editTextCity.getText().toString(), editTextEmail.getText().toString(),
                        editTextEmployeeID.getText().toString(), editTextFirstName.getText().toString(), editTextLastName.getText().toString(), editTextID.getText().toString(),editTextPhone.getText().toString());
                registerUser(user);
                ...
                if(filePath != null) {
                    ...
                    imagesRef.putFile(filePath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            Toast.makeText(NewEmployeeActivity.this, "Picture upload success", Toast.LENGTH_LONG).show();
                        }
                    });
                }
    ...
    private void registerUser(final Employes user){
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            DatabaseReference usersRef = mDatabase.child("Employes");
                            ...
                            Toast.makeText(NewEmployeeActivity.this, "Failed Registration: "+e.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        switch (item.getItemId()){
            ...
            case PHOTO_CAMERA:
                ...
                if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                    ...
                    try {
                        uriSavedImage = FileProvider.getUriForFile(NewEmployeeActivity.this,
